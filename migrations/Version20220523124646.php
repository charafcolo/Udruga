 ...
 */
final class Version20220523124646 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE event (id INT AUTO_INCREMENT NOT NULL, association_id INT DEFAULT NULL, title VARCHAR(255) NOT NULL, type VARCHAR(64) NOT NULL, description LONGTEXT NOT NULL, date DATETIME NOT NULL, max_member INT NOT NULL, price DOUBLE PRECISION DEFAULT NULL, status VARCHAR(64) NOT NULL, image VARCHAR(255) DEFAULT NULL, slug VARCHAR(255) DEFAULT NULL, INDEX IDX_3BAE0AA7EFB9C8A5 (association_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
